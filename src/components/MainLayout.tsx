    ...
    <div className="app-shell-bg min-h-dvh bg-background">
      <HierarchyNavProvider>
        ...
        >
          ...
          <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden px-0 pb-[calc(env(safe-area-inset-bottom)+5.25rem)] pt-0 sm:pb-[calc(env(safe-area-inset-bottom)+1rem)]">
            <Outlet />
          </main>
        </motion.div>
        <MobileBottomNav />
