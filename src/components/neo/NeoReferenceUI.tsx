...
export const recentDecisions = [
  ...
  { status: 'Delegado', title: 'Dashboard Comercial Novembro.pdf', meta: 'Delegado para Felipe Andrade  •  17/12/2024', tone: 'amber' },
];
              ...
              {approvals ? (
                <>
                  ...
                  <div className="rounded-lg bg-muted/50 p-2">
                    ...
                    <p className="mt-1 font-medium text-foreground">{['Mariana Alves', 'Rafael Costa', 'Beatriz Rocha', 'Felipe Andrade', 'Lucas Martins', 'Camila Torres'][index]}</p>
                  </div>
                </>
              ) : (
                <>
              ...
              {approvals ? (
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0">
                      <p className="max-w-[140px] truncate text-foreground">{['Mariana Alves', 'Rafael Costa', 'Beatriz Rocha', 'Felipe Andrade', 'Lucas Martins', 'Camila Torres'][index]}</p>
