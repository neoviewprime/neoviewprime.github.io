  ...
  return (
    <>
      <div className="neo-page">
        ...
        <PageTitle title="Central de Ajuda" description="Estamos aqui para ajudar você a tirar o máximo do NeoView." />
            ...
            <Panel title="IRIS · Assistente NeoView">
              <div className="flex gap-4">
                ...
                <div className="rounded-xl border border-border/60 bg-white/[0.035] p-4 text-sm text-muted-foreground">
                  Olá! Sou a IRIS, sua assistente inteligente. Posso te ajudar a encontrar relatórios, entender indicadores ou tirar dúvidas sobre o sistema.
                </div>
              </div>
